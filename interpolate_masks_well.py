...
parser.add_argument('--n_jobs', type=int, default=1, help='number of threads to use.')
...
if args.n_jobs == 1:
    ...
    p = Pool(args.n_jobs)
    res = p.map(part_mask_interp, range(0, args.max_xy))
    p.close()
